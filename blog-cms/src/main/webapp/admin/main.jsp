...
<div region="west" style="width: 200px" split="true" title="导航菜单">
    <div style="padding-top: 10px;padding-left: 10px">
        <a href="javascript:openTab('文章信息管理','articleManage.jsp','icon-bkgl')" class="easyui-linkbutton"
           data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">文章信息管理</a>
        <a href="javascript:openTab('文章类别管理','arcTypeManage.jsp','icon-bklb')" class="easyui-linkbutton"
           data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">文章类别管理</a>
...
<div region="south" style="height: 25px;padding-top: 5px" align="center">
    Copyright © 技术博客采集网
</div>

<div id="dlg" class="easyui-dialog" style="width: 400px;height: 200px;padding: 10px 20px" closed="true"
     buttons="#dlg-buttons" data-options="onClose:resetValue">
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>确认新密码：</td>
                <td>
                    <input type="password" id="rePassword" name="rePassword" class="easyui-validatebox"
                           required="true" style="width: 200px"/>
                </td>
            </tr>
        </table>

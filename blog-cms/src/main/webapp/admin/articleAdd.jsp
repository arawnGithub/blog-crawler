...
<head>
    ...
    <script type="text/javascript">
        function submitData() {
            ...
            var tags = $("#tags").val();
            var content = CKEDITOR.instances.articleAddContent.getData();
            var summary = CKEDITOR.instances.articleAddContent.document.getBody().getText().substr(0, 155);
        ...
        function resetValue() {
            ...
            $("#tags").val("");
            CKEDITOR.instances.articleAddContent.setData("");
        }
...
<div id="p" class="easyui-panel" title="编写文章" style="padding: 10px">
    <table cellspacing="10px">
        ...
        <tr>
            ...
            <td>
                <textarea id="articleAddContent" name="articleAddContent" rows="30" cols="80"></textarea>
            </td>
        </tr>
        <tr>
            <td></td>
...
<script type="text/javascript">
    CKEDITOR.replace("articleAddContent");
</script>
</body>
</html>
...
<table id="dg" class="easyui-datagrid" title="友情链接管理"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>排列序号：</td>
                <td>
                    <input type="text" id="sortNo" name="sortNo" class="easyui-numberbox" required="true"
                           style="width: 60px"/>&nbsp;(类别根据排列序号从小到大排列)
                </td>
            </tr>
        </table>
    </form>

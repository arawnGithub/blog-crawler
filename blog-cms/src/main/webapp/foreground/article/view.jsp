...
<div class="data_list">
    ...
    <div>
        ...
        <div class="article_info">
            转载自：<a href="${article.originalUrl}" target="_blank">互联网</a>&nbsp;&nbsp;发布时间：『 <fmt:formatDate
                value="${article.releaseDate}" type="date"
                pattern="yyyy-MM-dd HH:mm"/>』&nbsp;&nbsp;文章类别：${article.arcType.typeName}&nbsp;&nbsp;阅读(${article.clickHit})
        </div>

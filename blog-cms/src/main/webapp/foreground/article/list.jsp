                ...
                <li style="margin-bottom: 30px">
                    <span class="date">
                        <a href="${pageContext.request.contextPath}/article/${article.id}.html">
                            <fmt:formatDate value="${article.releaseDate}" type="date" pattern="yyyy年MM月dd日"/>
                        </a>
                    </span>
                    <span class="title">
                        <a href="${pageContext.request.contextPath}/article/${article.id}.html">
                    ...
                    <span class="info">发布于
                        <fmt:formatDate value="${article.releaseDate}" type="date" pattern="yyyy-MM-dd HH:mm"/> 阅读(${article.clickHit})
                    </span>
                </li>

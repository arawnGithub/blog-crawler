...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitData() {
            ...
            $.post("${pageContext.request.contextPath}/myManager/login.do", {
                username: username,
                password: password
            }, function (result) {
                if (result.success) {
...
<div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    ...
    <div class="input-group m-b-20">
        ...
        <div class="fg-line">
            <input value="${manager.username}" type="text" id="username" name="username" class="form-control" placeholder="username" regex="^\w{3,16}$"/>
        </div>
    </div>
    ...
    <div class="input-group m-b-20">
        ...
        <div class="fg-line">
            <input value="${manager.password}" type="password" id="password" name="password" class="form-control" placeholder="password" regex="^\w+"/>
        </div>
    </div>

            ...
            <div class="datas">
                <ul>
                    <c:forEach var="arcType" items="${arcTypeList}">
                        <li>
                            <span>
                                <a href="${pageContext.request.contextPath}/index.html?typeId=${arcType.id}">
                                    ${arcType.typeName}
                                </a>
                            </span>
                        </li>
            ...
            <div class="hostDatas">
                <ul>
                    <c:forEach var="hotArticle" items="${hotArticleList}" varStatus="status">
                        <li>
                            <span>
                                <a href="${pageContext.request.contextPath}/article/${hotArticle.id}.html" title="${hotArticle.title}">
                                     ${status.index+1}、${hotArticle.title}
                                </a>
                            </span>
                        </li>
                    </c:forEach>
